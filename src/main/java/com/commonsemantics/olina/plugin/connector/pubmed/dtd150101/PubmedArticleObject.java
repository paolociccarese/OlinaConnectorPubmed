...
import com.commonsemantics.olina.plugin.connector.pubmed.dtd150101.xml.*;
import com.commonsemantics.olina.plugin.connector.pubmed.dtd150101.xml.Object;
 ...
 */
public class PubmedArticleObject implements IBibliographicObject {
    private PubmedArticle article;
    private String swanId;

    private String[] MONTH_ABBREV_ARRAY = {"JAN", "FEB", "MAR", "APR", "MAY", "JUN", "JUL", "AUG", "SEP", "OCT", "NOV", "DEC"};
    private List<String> MONTH_ABBREVS = Arrays.asList(MONTH_ABBREV_ARRAY);


    PubmedArticleObject(PubmedArticle article) {
        super();
        this.article = article;
    }

    public List<String> getMonthAbbrevs() {
    ...
    public class ExternalAuthor {
        ...
        public String getForname() {
            List<Object> boh = theAuthor.getLastNameOrForeNameOrInitialsOrSuffixOrCollectiveName();
            for (java.lang.Object o : boh) {
