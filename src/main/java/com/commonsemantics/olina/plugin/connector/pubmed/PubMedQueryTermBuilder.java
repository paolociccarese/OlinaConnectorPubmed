...
//	}
    ...
    */
    ...
    private List<String> getSearchClauses(){
        ...
        Set<Map.Entry<String,List<String>>> tagAndFieldValues = tagToFieldValuesMap.entrySet();
        for(Map.Entry<String,List<String>> tagAndFieldValueList : tagAndFieldValues){
